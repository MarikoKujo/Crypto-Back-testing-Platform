...
# Hard-code default ohlc_ratios_per_sid
# This dict works as a default param in init() of class BcolzMinuteBarWriter:
# init(ohlc_ratios_per_sid=ohlc_ratios)
# Sids are assigned to all assets in alphabetical order. To add or delete an
# asset safely, first clean all ingests, then calculate sids for all assets,
# then update this dict accordingly, finally do the ingestion for all assets.
# If daily data should be used, add the same dict to daily_bars.py

# BTCUSDT: sid 0, uses default OHLC_RATIO = 1000
# ETHBTC: sid 1, 10^6
...
class BcolzMinuteBarWriter(object):
    ...
    def __init__(self,
                 ...
                 ohlc_ratios_per_sid=ohlc_ratios,
